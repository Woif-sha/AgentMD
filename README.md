...
│  └─ rules/             按条件读取的详细规则
├─ scripts/
│  ├─ install-links.sh   首次安装与后续同步
│  └─ validate-links.sh  检查安装状态和文档链接
...
```text
$HOME/.agentmd-backups/<timestamp>/
```
...
| [`conorbronsdon/avoid-ai-writing`](https://github.com/conorbronsdon/avoid-ai-writing) | [`58a95fc`](https://github.com/conorbronsdon/avoid-ai-writing/commit/58a95fc9971d7af95f1f1324b8a6bc991eb8004d) | 调整后采用 | 引入结论先行、信息密度、按内容组织和保留作者事实与声音边界的写作规则 | [`5339754`](https://github.com/Woif-sha/AgentMD/commit/533975453d7a81cf0494a9699c257c8766770b52) |
