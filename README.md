...
| [`conorbronsdon/avoid-ai-writing`](https://github.com/conorbronsdon/avoid-ai-writing) | [`58a95fc`](https://github.com/conorbronsdon/avoid-ai-writing/commit/58a95fc9971d7af95f1f1324b8a6bc991eb8004d) | 调整后采用 | 引入实质先行、信息密度、按受众表达和保留作者事实与声音边界的写作规则 | — |
